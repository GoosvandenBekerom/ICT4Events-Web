<%@ Page Title="Registreren klant" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Webform.aspx.cs" EnableEventValidation="true" Inherits="ProofOfConceptWebtechnieken.Webform" %>
    ...
    <p>Op deze pagina staat een registratieformulier die het concept van het registreren van een nieuwe gebruiker met validatie uitbeeldt.
        ...
        <fieldset>
            ...
            <div class="form-group">              
              ...
              <asp:CustomValidator ID="test1" Enabled="true" runat="server" ControlToValidate="phone_number" ClientValidationFunction="validatePhoneNumber" CssClass="text-danger" Display="Dynamic" ErrorMessage="Telefoonnummer is niet geldig" ValidateEmptyText="False" ValidationGroup="RegistrationGroup" /> 
            </div>
